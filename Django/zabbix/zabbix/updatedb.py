...
from zabbix.moniter.models import Zabbix_moniter
...
class get_hostinfo:
    # 先定义API要用的基本信息
    def __init__(self):
        self.url = 'http://120.27.232.133:2000/zabbix/api_jsonrpc.php'
    ...
    def update_sqlite(self,name,ipaddr,ping,disk):
        ...
        zabbix_moniter,create = Zabbix_moniter.object.update_or_create(
            ip = ipaddr,defaults={
...
def main():
    ...
    for a, b, c, d, e in zip(names, ips, pings, disk):
        print(a, b, c, d)
